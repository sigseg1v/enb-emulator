...
-- Records 
-- ----------------------------
-- Phase X: Argon2id PHC for the dev plaintext 'devadmin'.
INSERT INTO `accounts` VALUES ('1', 'admin', '$argon2id$v=19$m=65536,t=2,p=1$Ads+f2cCrWhNunncp/JlMg$ej6fHmo+zSY0S7XbvquWZDfWiG8oTTx+iZbzdEznYTA', '100', 'no_form_name', 'noemail@net-7.org', '1989-12-30 00:00:00', '1989-12-30 00:00:00', '0');
