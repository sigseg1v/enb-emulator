-- Generated by db/postgres/convert.sh — do not edit by hand.
...
-- ----------------------------
DROP TABLE IF EXISTS "account_avatar_forumname" CASCADE;
...
CREATE TABLE "account_infractions" (
  ...
  -- INDEX TODO: Index_AccountID ON ("account_ID")
);

-- ----------------------------
-- Table structure for account_status_levels
-- ----------------------------
DROP TABLE IF EXISTS "account_status_levels" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_ammo" CASCADE;
CREATE TABLE "avatar_ammo" (
  "avatar_id" integer NOT NULL,
  "equipment_slot" integer NOT NULL DEFAULT '0',
  "item_id" integer DEFAULT NULL,
  "quality" float DEFAULT NULL,
  "ammo_stack" integer DEFAULT NULL,
  "builder_name" text,
  "structure" float DEFAULT NULL,
  PRIMARY KEY ("avatar_id","equipment_slot")
  -- INDEX TODO: avatar_ammo_ik1 ON ("avatar_id","equipment_slot")
);

-- ----------------------------
-- Table structure for avatar_base
-- ----------------------------
DROP TABLE IF EXISTS "avatar_base" CASCADE;
CREATE TABLE "avatar_base" (
  "Race" smallint NOT NULL,
  "Profession" smallint NOT NULL,
  "base_shield" bigint NOT NULL,
  "base_reactor" bigint NOT NULL,
  "base_engine" bigint NOT NULL,
  "base_weapon" bigint NOT NULL,
  "base_hull_asset" bigint NOT NULL,
  "base_profession_asset" bigint NOT NULL,
  "base_wing_asset" bigint NOT NULL,
  "base_engine_asset" bigint NOT NULL,
  "starting_sector" bigint NOT NULL,
  "base_faction" bigint NOT NULL,
  "base_scan_range" bigint NOT NULL,
  "base_signature" bigint NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_data" CASCADE;
CREATE TABLE "avatar_data" (
  ...
  "pants" smallint NOT NULL,
  "head" smallint NOT NULL,
  "hair" smallint NOT NULL,
  "ear" smallint NOT NULL,
  "goggle" smallint NOT NULL,
  "beard" smallint NOT NULL,
  "weapon_hip" smallint NOT NULL,
  "weapon_unique" smallint NOT NULL,
  "weapon_back" smallint NOT NULL,
  "head_texture" smallint NOT NULL,
  "tattoo_texture" smallint NOT NULL,
  ...
  "shirt_p_metal" integer NOT NULL,
  "shirt_s_metal" integer NOT NULL,
  "pants_p_metal" integer NOT NULL,
  "pants_s_metal" integer NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_equipment" CASCADE;
CREATE TABLE "avatar_equipment" (
  ...
  PRIMARY KEY ("avatar_id","equipment_slot")
  -- INDEX TODO: avatar_equipment_ik1 ON ("avatar_id","equipment_slot")
);

-- ----------------------------
-- Table structure for avatar_exploration
-- ----------------------------
DROP TABLE IF EXISTS "avatar_exploration" CASCADE;
CREATE TABLE "avatar_exploration" (
  "avatar_id" integer NOT NULL,
  "object_id" integer NOT NULL,
  "explore_flags" smallint NOT NULL
  -- INDEX TODO: avatar_exploration_ik1 ON ("avatar_id","object_id")
);

-- ----------------------------
-- Table structure for avatar_faction_level
-- ----------------------------
DROP TABLE IF EXISTS "avatar_faction_level" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_gm_items" CASCADE;
CREATE TABLE "avatar_gm_items" (
  "avatar_id" integer NOT NULL DEFAULT '0',
  "item_id" integer NOT NULL,
  "stack_level" integer NOT NULL,
  "trade_stack" integer NOT NULL,
  "quality" real NOT NULL,
  "cost" integer NOT NULL,
  "builder_name" text NOT NULL,
  "structure" real NOT NULL,
  PRIMARY KEY ("avatar_id","item_id")
  -- INDEX TODO: avatar_inventory_items_ik1 ON ("avatar_id")
);

-- ----------------------------
-- Table structure for avatar_info
-- ----------------------------
DROP TABLE IF EXISTS "avatar_info" CASCADE;
CREATE TABLE "avatar_info" (
  ...
  "combat" bigint NOT NULL,
  "explore" bigint NOT NULL,
  "trade" bigint NOT NULL,
  "engine_trail_type" integer DEFAULT NULL,
  "last_login" timestamp NOT NULL DEFAULT '1989-12-30 00:00:00',
  "last_logout" timestamp NOT NULL DEFAULT '1989-12-30 00:00:00',
  "last_logout_t" bigint DEFAULT NULL,
  "time_played" bigint NOT NULL DEFAULT '0',
  PRIMARY KEY ("avatar_id")
  -- INDEX TODO: FK_avatar_info_1 ON ("account_id")
  -- FK TODO
);
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_inventory_items" CASCADE;
CREATE TABLE "avatar_inventory_items" (
  "avatar_id" integer NOT NULL DEFAULT '0',
  "item_id" integer DEFAULT NULL,
  "stack_level" integer DEFAULT NULL,
  "inventory_slot" integer NOT NULL DEFAULT '0',
  "trade_stack" integer DEFAULT NULL,
  "quality" real DEFAULT NULL,
  "cost" integer DEFAULT NULL,
  "builder_name" text,
  "structure" real DEFAULT NULL,
  PRIMARY KEY ("avatar_id","inventory_slot")
  -- INDEX TODO: avatar_inventory_items_ik1 ON ("avatar_id","inventory_slot")
);

-- ----------------------------
-- Table structure for avatar_level_info
-- ----------------------------
DROP TABLE IF EXISTS "avatar_level_info" CASCADE;
CREATE TABLE "avatar_level_info" (
  "avatar_id" integer NOT NULL,
  "player_rank_name" integer NOT NULL,
  "hull_upgrade_level" integer NOT NULL,
  "hull_points" float NOT NULL,
  "max_hull_points" float NOT NULL,
  "credits" numeric(20,0) NOT NULL,
  ...
  "weapon_slots" integer DEFAULT NULL,
  "device_slots" integer DEFAULT NULL,
  "skill_points" integer DEFAULT NULL,
  "engine_thrust_type" integer NOT NULL,
  "warp_power_level" integer NOT NULL,
  "registered_starbase" integer DEFAULT NULL,
  "reactor_level" float DEFAULT NULL,
  "shield_level" float DEFAULT NULL,
  "xp_debt" bigint NOT NULL DEFAULT '0',
  "last_debt" bigint NOT NULL DEFAULT '0',
  PRIMARY KEY ("avatar_id")
);
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_mission_progress" CASCADE;
CREATE TABLE "avatar_mission_progress" (
  "avatar_id" integer NOT NULL,
  "mission_slot" integer NOT NULL DEFAULT '0',
  "mission_id" integer DEFAULT NULL,
  "stage_num" integer DEFAULT NULL,
  "mission_flags" integer DEFAULT NULL,
  PRIMARY KEY ("avatar_id","mission_slot")
  -- INDEX TODO: avatar_mission_progress_ik1 ON ("avatar_id","mission_slot")
);
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_recipes" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "avatar_skill_levels" CASCADE;
CREATE TABLE "avatar_skill_levels" (
  ...
  -- INDEX TODO: avatar_skill_levels_ik1 ON ("avatar_id","skill_id")
);

-- ----------------------------
-- Table structure for avatar_trade_items
-- ----------------------------
DROP TABLE IF EXISTS "avatar_trade_items" CASCADE;
CREATE TABLE "avatar_trade_items" (
  ...
  "structure" real DEFAULT NULL,
  PRIMARY KEY ("avatar_id","inventory_slot")
  -- INDEX TODO: avatar_trade_items_ik1 ON ("avatar_id","inventory_slot")
);

-- ----------------------------
-- Table structure for avatar_vault_items
-- ----------------------------
DROP TABLE IF EXISTS "avatar_vault_items" CASCADE;
CREATE TABLE "avatar_vault_items" (
  ...
  "structure" real DEFAULT NULL,
  PRIMARY KEY ("avatar_id","inventory_slot")
  -- INDEX TODO: avatar_vault_items_ik1 ON ("avatar_id","inventory_slot")
);

-- ----------------------------
-- Table structure for cbasset
-- ----------------------------
DROP TABLE IF EXISTS "cbasset" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "faction_data" CASCADE;
CREATE TABLE "faction_data" (
  "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  "avatar_id" bigint NOT NULL,
  "faction_id" bigint NOT NULL,
  "faction_value" float NOT NULL,
  "faction_order" smallint NOT NULL,
  PRIMARY KEY ("id")
)  ;
...
CREATE TABLE "factions" (
  "faction_id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  "name" varchar(255) DEFAULT NULL,
  "description" text,
  "player_PDA" smallint DEFAULT NULL,
  "PDA_text" text,
...
-- ----------------------------
DROP TABLE IF EXISTS "forbidden_names" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "friends_lists" CASCADE;
CREATE TABLE "friends_lists" (
  "avatar_id" bigint NOT NULL,
  "name" varchar(20) NOT NULL,
  PRIMARY KEY ("avatar_id","name")
  -- INDEX TODO: Index_1 ON ("avatar_id")
);
...
-- ----------------------------
DROP TABLE IF EXISTS "guild_ranks" CASCADE;
CREATE TABLE "guild_ranks" (
  "id" bigint NOT NULL,
  "name" varchar(64) NOT NULL,
  "permissions" integer NOT NULL,
  "maxpromote" integer NOT NULL,
  "maxremove" integer NOT NULL,
  "mindemote" integer NOT NULL,
  PRIMARY KEY ("id") 
);
...
-- ----------------------------
DROP TABLE IF EXISTS "hulls" CASCADE;
CREATE TABLE "hulls" (
  "Race" smallint NOT NULL,
  "Profession" smallint NOT NULL,
  "upgrade_level" smallint NOT NULL,
  "hull_points" bigint NOT NULL,
  "weapon_slots" smallint NOT NULL,
  "device_slots" smallint NOT NULL,
  "cargo_slots" bigint NOT NULL
);

-- ----------------------------
-- Table structure for ignore_lists
-- ----------------------------
DROP TABLE IF EXISTS "ignore_lists" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "missions_completed" CASCADE;
CREATE TABLE "missions_completed" (
  "avatar_id" integer NOT NULL,
  "mission_id" integer DEFAULT NULL,
  "mission_completion_flags" integer DEFAULT NULL
  -- INDEX TODO: missions_completed_ik1 ON ("avatar_id","mission_id")
);
...
-- ----------------------------
DROP TABLE IF EXISTS "server_local_field_respawn_times" CASCADE;
CREATE TABLE "server_local_field_respawn_times" (
  "resource_id" integer DEFAULT NULL,
  "local_respawn_time" integer DEFAULT NULL
);

-- ----------------------------
-- Table structure for ship_data
-- ----------------------------
DROP TABLE IF EXISTS "ship_data" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "ship_info" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "skill_list" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "ssl_deny_list" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "status_levels" CASCADE;
...
-- ----------------------------
DROP TABLE IF EXISTS "warning_levels" CASCADE;
CREATE TABLE "warning_levels" (
  "sound_warning_level" integer DEFAULT NULL,
  "avatar_id" integer NOT NULL,
  PRIMARY KEY ("avatar_id")
);
...
-- Records 
-- ----------------------------
-- No seed account ships here. A built-in account with a committed (so
-- publicly known) password is a standing superadmin backdoor on every
-- deploy. Provision accounts at runtime instead: tools/seed-dev-account/
-- seed-dev-account.sh <user> <pass> (status=100) for dev, or the normal
-- registration/ChangePassword path. The integration suite provisions its
-- own throwaway rows (tests/.../TestAccounts.cs), so nothing depends on a
-- pre-seeded row.
...
-- Phase X: reset every IDENTITY sequence to MAX(id)+1 after the
-- explicit-id seeded rows. Generated by db/postgres/convert.sh.
DO $reset_identity$
DECLARE
    rec RECORD;
    seq_name text;
    ...
    LOOP
        ...
        IF seq_name IS NOT NULL THEN
            EXECUTE format('SELECT COALESCE(MAX(%I), 0) FROM %I.%I',
                ...
                INTO max_val;
            PERFORM setval(seq_name, GREATEST(max_val, 1), max_val > 0);
        END IF;
    END LOOP;
END $reset_identity$;

-- Fidelity: net7_user dump was latin1_swedish_ci (case-insensitive); the
-- COLLATE strip above + C.UTF-8 database made name matching case-sensitive.
-- citext restores _ci equality on the three behaviourally-load-bearing
-- name columns. Generated by db/postgres/convert.sh.
CREATE EXTENSION IF NOT EXISTS citext;
ALTER TABLE "accounts"        ALTER COLUMN "username"   TYPE citext;
ALTER TABLE "avatar_data"     ALTER COLUMN "first_name" TYPE citext;
ALTER TABLE "forbidden_names" ALTER COLUMN "nickname"   TYPE citext;
