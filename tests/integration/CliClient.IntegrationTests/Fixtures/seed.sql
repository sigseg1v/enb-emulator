...
DELETE FROM accounts WHERE id BETWEEN 9000001 AND 9000201;
...
VALUES
  ...
  (9000130, 'cli_test130',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test130_form',    'cli_test130@net-7.test',        0),
  ...
  (9000135, 'cli_test135',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test135_form',    'cli_test135@net-7.test',        0),
  (9000136, 'cli_test136',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test136_form',    'cli_test136@net-7.test',        0),
  (9000137, 'cli_test137',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test137_form',    'cli_test137@net-7.test',        0),
  (9000138, 'cli_test138',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test138_form',    'cli_test138@net-7.test',        0),
  (9000139, 'cli_test139',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test139_form',    'cli_test139@net-7.test',        0),
  (9000140, 'cli_test140',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test140_form',    'cli_test140@net-7.test',        0),
  (9000141, 'cli_test141',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test141_form',    'cli_test141@net-7.test',        0),
  (9000142, 'cli_test142',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test142_form',    'cli_test142@net-7.test',        0),
  (9000143, 'cli_test143',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test143_form',    'cli_test143@net-7.test',        0),
  (9000144, 'cli_test144',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test144_form',    'cli_test144@net-7.test',        0),
  (9000145, 'cli_test145',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test145_form',    'cli_test145@net-7.test',        0),
  (9000146, 'cli_test146',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test146_form',    'cli_test146@net-7.test',        0),
  (9000147, 'cli_test147',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test147_form',    'cli_test147@net-7.test',        0),
  (9000148, 'cli_test148',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test148_form',    'cli_test148@net-7.test',        0),
  (9000149, 'cli_test149',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test149_form',    'cli_test149@net-7.test',        0),
  (9000150, 'cli_test150',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test150_form',    'cli_test150@net-7.test',        0),
  (9000151, 'cli_test151',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test151_form',    'cli_test151@net-7.test',        0),
  (9000152, 'cli_test152',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test152_form',    'cli_test152@net-7.test',        0),
  (9000153, 'cli_test153',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test153_form',    'cli_test153@net-7.test',        0),
  (9000154, 'cli_test154',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test154_form',    'cli_test154@net-7.test',        0),
  (9000155, 'cli_test155',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test155_form',    'cli_test155@net-7.test',        0),
  (9000156, 'cli_test156',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test156_form',    'cli_test156@net-7.test',        0),
  (9000157, 'cli_test157',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test157_form',    'cli_test157@net-7.test',        0),
  (9000158, 'cli_test158',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test158_form',    'cli_test158@net-7.test',        0),
  (9000159, 'cli_test159',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test159_form',    'cli_test159@net-7.test',        0),
  (9000160, 'cli_test160',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test160_form',    'cli_test160@net-7.test',        0),
  (9000161, 'cli_test161',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test161_form',    'cli_test161@net-7.test',        0),
  (9000162, 'cli_test162',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test162_form',    'cli_test162@net-7.test',        0),
  (9000163, 'cli_test163',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test163_form',    'cli_test163@net-7.test',        0),
  (9000164, 'cli_test164',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test164_form',    'cli_test164@net-7.test',        0),
  (9000165, 'cli_test165',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test165_form',    'cli_test165@net-7.test',        0),
  (9000166, 'cli_test166',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test166_form',    'cli_test166@net-7.test',        0),
  (9000167, 'cli_test167',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test167_form',    'cli_test167@net-7.test',        0),
  (9000168, 'cli_test168',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test168_form',    'cli_test168@net-7.test',        0),
  (9000169, 'cli_test169',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test169_form',    'cli_test169@net-7.test',        0),
  (9000170, 'cli_test170',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test170_form',    'cli_test170@net-7.test',        0),
  (9000171, 'cli_test171',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test171_form',    'cli_test171@net-7.test',        0),
  (9000172, 'cli_test172',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test172_form',    'cli_test172@net-7.test',        0),
  (9000173, 'cli_test173',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test173_form',    'cli_test173@net-7.test',        0),
  (9000174, 'cli_test174',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test174_form',    'cli_test174@net-7.test',        0),
  (9000175, 'cli_test175',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test175_form',    'cli_test175@net-7.test',        0),
  (9000176, 'cli_test176',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test176_form',    'cli_test176@net-7.test',        0),
  (9000177, 'cli_test177',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test177_form',    'cli_test177@net-7.test',        0),
  (9000178, 'cli_test178',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test178_form',    'cli_test178@net-7.test',        0),
  (9000179, 'cli_test179',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test179_form',    'cli_test179@net-7.test',        0),
  (9000180, 'cli_test180',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test180_form',    'cli_test180@net-7.test',        0),
  (9000181, 'cli_test181',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test181_form',    'cli_test181@net-7.test',        0),
  (9000182, 'cli_test182',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test182_form',    'cli_test182@net-7.test',        0),
  (9000183, 'cli_test183',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test183_form',    'cli_test183@net-7.test',        0),
  (9000184, 'cli_test184',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test184_form',    'cli_test184@net-7.test',        0),
  (9000185, 'cli_test185',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test185_form',    'cli_test185@net-7.test',        0),
  (9000186, 'cli_test186',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test186_form',    'cli_test186@net-7.test',        0),
  (9000187, 'cli_test187',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test187_form',    'cli_test187@net-7.test',        0),
  (9000188, 'cli_test188',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test188_form',    'cli_test188@net-7.test',        0),
  (9000189, 'cli_test189',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test189_form',    'cli_test189@net-7.test',        0),
  (9000190, 'cli_test190',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test190_form',    'cli_test190@net-7.test',        0),
  (9000191, 'cli_test191',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test191_form',    'cli_test191@net-7.test',        0),
  (9000192, 'cli_test192',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test192_form',    'cli_test192@net-7.test',        0),
  (9000193, 'cli_test193',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test193_form',    'cli_test193@net-7.test',        0),
  (9000194, 'cli_test194',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test194_form',    'cli_test194@net-7.test',        0),
  (9000195, 'cli_test195',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test195_form',    'cli_test195@net-7.test',        0),
  (9000196, 'cli_test196',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test196_form',    'cli_test196@net-7.test',        0),
  (9000197, 'cli_test197',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test197_form',    'cli_test197@net-7.test',        0),
  (9000198, 'cli_test198',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test198_form',    'cli_test198@net-7.test',        0),
  (9000199, 'cli_test199',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test199_form',    'cli_test199@net-7.test',        0),
  (9000200, 'cli_test200',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test200_form',    'cli_test200@net-7.test',        0),
  (9000201, 'cli_test201',        UPPER(encode(digest('testpw', 'md5'), 'hex')), 100, 'cli_test201_form',    'cli_test201@net-7.test',        0),
