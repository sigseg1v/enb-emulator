...
public static class TestAccounts
{
    ...
    public static IReadOnlyList<TestAccount> Pool { get; } = new TestAccount[]
    {
        ...
        new(9_000_030, "cli_test30", SharedPassword),
        ...
        new(9_000_035, "cli_test35", SharedPassword),
        new(9_000_036, "cli_test36", SharedPassword),
        new(9_000_037, "cli_test37", SharedPassword),
        new(9_000_038, "cli_test38", SharedPassword),
        new(9_000_039, "cli_test39", SharedPassword),
        new(9_000_040, "cli_test40", SharedPassword),
        new(9_000_041, "cli_test41", SharedPassword),
        new(9_000_042, "cli_test42", SharedPassword),
        new(9_000_043, "cli_test43", SharedPassword),
        new(9_000_044, "cli_test44", SharedPassword),
        new(9_000_045, "cli_test45", SharedPassword),
        new(9_000_046, "cli_test46", SharedPassword),
        new(9_000_047, "cli_test47", SharedPassword),
        new(9_000_048, "cli_test48", SharedPassword),
    };
