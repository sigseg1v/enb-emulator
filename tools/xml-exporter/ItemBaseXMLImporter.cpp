    ...
    for (int i = 0; i < ItemCount; i++) {
        ...
        for (int j = 0; j < ItemFieldCount; j++) {
            ...
            case 0x1B: // #27 = String for 0x1C
                strcpy(m_ItemData->m_ItemFields[ItemFieldType].sData,
                       strVal(m_ItemField.getText()));
            ...
            default:
                printf("Uknown ItemField: %d Item: %d", ItemFieldType,
                       m_ItemData->m_ItemTemplateID);
                return;
            }
        ...
        for (int k = 0; k < ItemEffectCount; k++) {
            ...
            strcpy(m_Effect->Description,
                   strVal(m_ItemEffect.getChildNode("Description").getText()));
            ...
            for (int x = 0; x < ItemEffectDescVarCount; x++) {
                ...
                m_Effect->DescVar[m_Effect->DescVarCount++] =
                    floatVal(m_ItemEffectDescVar.getText());
            }
        }
