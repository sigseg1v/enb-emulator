...
A toolbar/menu exposes New / Copy / Save / Delete / Refresh against the live MySQL DB through `commontools` (`DB.Instance`).
...
smoke OK: all 5 mob-editor windows instantiated
```
