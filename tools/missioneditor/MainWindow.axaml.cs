...
namespace MissionEditor
{
    ...
    //     talktreeeditor project (same pattern as station-tools).
    //     Round-trip back into the stage's talk tree is not yet wired
    //     because talktreeeditor does not return its result.
    public partial class MainWindow : Window
    {
        ...
        void OnTalkTree(object sender, RoutedEventArgs e)
        {
            ...
            // talktreeeditor is a separate process; it accepts XML
            ...
            try
            {
                ...
                var psi = new ProcessStartInfo("dotnet", "run --project ../talktreeeditor/")
                {
                    UseShellExecute = false
                };
                Process.Start(psi);
                c_StatusLbl.Text = "launched talktreeeditor (round-trip not wired)";
                _ = conversation;
            }
