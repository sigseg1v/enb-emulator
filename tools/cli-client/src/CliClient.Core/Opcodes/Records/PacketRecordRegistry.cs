...
public static class PacketRecordRegistry
{
    ...
    public static IPacketRecord Resolve(ushort opcode, ReadOnlySpan<byte> payload)
    {
        return opcode switch
        {
            ...
            0x001E => new GroupRecord(payload),
            ...
            0x00A6 => new ClientChatErrorRecord(payload),
            ...
            0x00C8 => new GuildRecruitConfirmRecord(payload),
            0x00CC => new GuildSimpleSectorRecord(payload),
