...
Depends on `commontools` for the Login dialog +
...
```sh
dotnet build tools/dataimport/DataImport.csproj
```
...
```sh
dotnet tools/dataimport/bin/Debug/net10.0/DataImport.dll
```
...
```sh
dotnet tools/dataimport/bin/Debug/net10.0/DataImport.dll --smoke
```
