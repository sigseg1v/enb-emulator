...
// Ported from N7.Sprites.Stargate under Net-7 Entertainment's
...
namespace SectorEditorAvalonia.Sprites
{
    ...
    {
        public Stargate(PLayer layer, string name, float x, float y, float sigRadius, float rrRadius)
        {
            SpritePlaceholder.Build(layer, name, x, y, sigRadius, rrRadius,
                "standardGate.gif", Color.ForestGreen, Color.GreenYellow);
        }
    }
}
