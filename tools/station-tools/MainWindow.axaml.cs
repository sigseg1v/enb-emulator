...
namespace StationTools
{
    ...
    //     talktreeeditor project (same pattern as the editor
    //     launcher).
    ...
    public partial class MainWindow : Window
    {
        ...
        void OnEditTalkTree(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                // (talktreeeditor/Program.cs). Hand it the selected
                ...
                psi.ArgumentList.Add("../talktreeeditor/");
                ...
                c_Status.Text = string.IsNullOrEmpty(m_TalkTreeData)
                    ? "launched talktreeeditor (no talk tree on this NPC)"
                    : "launched talktreeeditor with this NPC's talk tree";
            }
