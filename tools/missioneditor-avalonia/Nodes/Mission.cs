...
{
    // Ported verbatim from tools/missioneditor/Nodes/Mission.cs.
    // System.Windows.Forms references swapped for Console.Error.WriteLine.
    public class Mission
    {
        ...
        public void setForfeitable(Boolean forfeitable) { m_forfeitable = forfeitable; }
        public Boolean isForfeitable() { return m_forfeitable; }
        public void setAllowedTime(Int32 time) { m_allowedTime = time; }
        public Int32 getAllowedTime() { return m_allowedTime; }
        public void setName(String name) { m_name = name; }
        public String getName() { return m_name; }
        public void setSummary(String summary) { m_summary = summary; }
        public String getSummary() { return m_summary; }
        public void setOverallLevel(Int32 overallLevel) { m_overallLevel = overallLevel; }
        public Int32 getOverallLevel() { return m_overallLevel; }
        public void setXml(String xml) { m_xml = xml; }
        public String getXml() { return m_xml; }
        public void setType(MissionType type) { m_missionType = type; }
        public MissionType getType() { return m_missionType; }
        public void setKey(String key) { m_key = key; }
        public String getKey() { return m_key; }

        public void addCondition(Condition condition)
        {
            if (m_conditions == null) m_conditions = new List<Condition>();
            m_conditions.Add(condition);
        }

        public Boolean hasConditions() { return m_conditions != null && m_conditions.Count != 0; }
        public List<Condition> getConditions() { return m_conditions; }
        public void removeCondition(Condition condition) { if (m_conditions != null) m_conditions.Remove(condition); }
        public void clearConditions() { if (m_conditions != null) m_conditions.Clear(); }

        public void addStage(Stage stage)
        {
            if (m_stages == null) m_stages = new List<Stage>();
            m_stages.Add(stage);
        }

        public Boolean hasStages() { return m_stages != null && m_stages.Count != 0; }
        public List<Stage> getStages() { return m_stages; }
        public void removeStage(Stage stage) { if (m_stages != null) m_stages.Remove(stage); }
        public void clearStages() { if (m_stages != null) m_stages.Clear(); }
        ...
        private void fromXML(XmlNode xmlNode)
        {
            ...
            foreach (XmlNode missionChild in xmlNode.ChildNodes)
            {
                ...
                {
                    Console.Error.WriteLine("Unexpected node: " + missionChild.Name + " in the" + XmlTag.MISSION + " tag");
                }
            }
