...
```sh
dotnet build tools/toolspatcher/ToolsPatcher.csproj
```
...
```sh
dotnet tools/toolspatcher/bin/Debug/net10.0/ToolsPatcher.dll [LauncherExe]
```
...
```sh
dotnet tools/toolspatcher/bin/Debug/net10.0/ToolsPatcher.dll --smoke
```
...
considerably more — see [`plans/12-phase-l.md`](../../plans/12-phase-l.md)
