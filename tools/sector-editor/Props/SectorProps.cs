...
namespace N7.Props
{
    ...
    class SectorProps
    {
        ...
        public int GridX { get { return grid_x; } set { grid_x = value; } }

        [CategoryAttribute("Misc. Properties"), DescriptionAttribute("Description and values currently unkown, leave be for the time being.")]
        public int GridY { get { return grid_y; } set { grid_y = value; } }

        [CategoryAttribute("Misc. Properties"), DescriptionAttribute("Description and values currently unkown, leave be for the time being.")]
        public int GridZ { get { return grid_z; } set { grid_z = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Fog near visibility, distance at which you start to see the sector fog.")]
        public float FogNear { get { return fog_near; } set { fog_near = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Fog far visibility, distance at which you cant see anything anymore.")]
        public float FogFar { get { return fog_far; } set { fog_far = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Sets the background debris mode, values currently unknown.")]
        public int DebrisMode { get { return debris_mode; } set { debris_mode = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Description and values currently unkown, leave be for the time being.")]
        public bool LightBackdrop { get { return light_backdrop; } set { light_backdrop = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Description and values currently unkown, leave be for the time being.")]
        public bool FogBackdrop { get { return fog_backdrop; } set { fog_backdrop = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Description and values currently unkown, leave be for the time being.")]
        public bool SwapBackdrop { get { return swap_backdrop; } set { swap_backdrop = value; } }
        ...
        public float BackdropFogNear { get { return backdrop_fog_near; } set { backdrop_fog_near = value; } }
        ...
        public float BackdropFogFar { get { return backdrop_fog_far; } set { backdrop_fog_far = value; } }
        ...
        public float MaxTilt { get { return max_tilt; } set { max_tilt = value; } }
        ...
        public bool AutoLevel { get { return auto_level; } set { auto_level = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("The Maximum impulse rate of players in this sector")]
        public float ImpulseRate { get { return impulse_rate; } set { impulse_rate = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Description and values currently unkown, leave be for the time being.")]
        public float DecayVelocity { get { return decay_velocity; } set { decay_velocity = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Description and values currently unkown, leave be for the time being.")]
        public float DecaySpin { get { return decay_spin; } set { decay_spin = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("The id of the 3d base asset that represents this sectors background.")]
        public int BackdropAsset { get { return backdrop_asset; } set { backdrop_asset = value; } }

        [CategoryAttribute("Base Props"), DescriptionAttribute("Greetings you see upon entering the sector")]
        public string Greetings { get { return greetings; } set { greetings = value; } }
        ...
        public string SectorType
        {
            get
            {
                if (sector_type != null) return sector_type;
                if (HE_GlobalVars._listofSectorTypes.Length > 0)
                    return HE_GlobalVars._listofSectorTypes[0];
                return "";
            }
