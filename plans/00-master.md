...
| K | In-game opcode handlers + UDP proxy plane | [11-phase-k-ingame.md](11-phase-k-ingame.md) | in progress (TCP 3500 published, UDP plane minimum-viable subset for MasterJoin→ServerRedirect, per-connection threading in net7ssl, opcode round-trip test wired into `just integration-test`; opcode handlers + ticket handoff carry over) | 2026-05-23 | 2026-05-23 |
