...
| J | Runnable end-to-end | [10-phase-j-runnable.md](10-phase-j-runnable.md) | in progress (server UDP binds verified; Net7Proxy Linux port done — TCP 3801+3805+3500 bind in container, host port-publish works, accept loop logs peer IP; Westwood handshake/dispatch on Linux still stubbed; login-server + replay client still open) | 2026-05-23 | 2026-05-23 |
