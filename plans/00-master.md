...
| L | C# tools → Avalonia (Linux-native UI) | [12-phase-l-avalonia.md](12-phase-l-avalonia.md) | in progress (scoping done: 14 csprojs flagged WinForms, 64 real forms ~80k LOC, realistic 4-6 month full migration; Tier 0 quick wins + Tier 1 POC in scope this session; remaining 12 editors deferred — WINE remains the interim Linux path per tools/README.md) | 2026-05-23 | 2026-05-23 |
