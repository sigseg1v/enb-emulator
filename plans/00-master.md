...
| R | Extract `common/` for shared protocol headers | [18-phase-r-common-headers.md](18-phase-r-common-headers.md) | in progress (Wave 1 done: Opcodes.h + Mutex.h + WestwoodRC4.h + WestwoodRSA.h consolidated into common/include/net7/, all 3 binaries link [169/23/18]; Wave 2 next: PacketStructures.h per-struct merge incl. backporting Phase K int32_t fix to server/+login/, then extract port macros from Net7.h into common/include/net7/Ports.h) | 2026-05-23 | 2026-05-23 |
