...
### AS-15 Group frame action buttons + roster shift  `[~]`  (owner ask 2026-06-30)
...
- `[~]` **Live verify (needs client relaunch -- DLL changed)**: two grouped
  multibox clients; see plans/29 CV-AS-GRPBTN. 2026-07-01 agent-driven pass done:
  ...
  group_action(12) sent clean, no faults. Remaining: owner clicks the on-screen
  rows (disband/leave/formation/click-through).
