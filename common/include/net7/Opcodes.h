...
#define ENB_OPCODE_0003_LOGOFF							0x0003
...
#define ENB_OPCODE_000A_POINT_EFFECT					0x000A
#define ENB_OPCODE_000B_OBJECT_TO_OBJECT_EFFECT			0x000B
#define ENB_OPCODE_000E_OBJECT_TO_OBJECT_LINKED_EFFECT  0x000E
#define	ENB_OPCODE_000F_REMOVE_EFFECT					0x000F

#define ENB_OPCODE_0010_DECAL                           0x0010
#define ENB_OPCODE_0011_COLORIZATION                    0x0011
#define ENB_OPCODE_0012_TURN                            0x0012
#define ENB_OPCODE_0013_TILT                            0x0013
#define ENB_OPCODE_0014_MOVE                            0x0014
#define ENB_OPCODE_0017_REQUEST_TARGET                  0x0017
#define ENB_OPCODE_0018_REQUEST_TARGETS_TARGET          0x0018
...
#define	ENB_OPCODE_001E_GROUP							0x001E
#define ENB_OPCODE_001F_TRADE			                0x001F

#define ENB_OPCODE_0020_PRIORITY_MESSAGE				0x0020
#define ENB_OPCODE_0022_PUSH_MESSAGE					0x0022
#define ENB_OPCODE_0025_ITEM_BASE                       0x0025
#define ENB_OPCODE_0026_CHANGE_BASE_ASSET				0x0026
#define ENB_OPCODE_0027_INVENTORY_MOVE					0x0027
#define ENB_OPCODE_0027_INVENTORY_SORT					0x0028
#define ENB_OPCODE_0029_ITEM_STATE					    0x0029
#define ENB_OPCODE_002A_SET_ZBAND                       0x002A
#define ENB_OPCODE_002B_SET_BBOX                        0x002B
#define ENB_OPCODE_002C_ACTION                          0x002C
#define ENB_OPCODE_002D_ACTION2							0x002D
...
#define ENB_OPCODE_0041_FORMATION_POSITIONAL_UPDATE		0x0041
#define ENB_OPCODE_0042_SERVER_PARAMETERS               0x0042
#define ENB_OPCODE_0043_REQUEST_TRANSFORM_CHANGE        0x0043
...
#define ENB_OPCODE_0051_SKILL_STRING_RQ					0x0051
#define ENB_OPCODE_0052_LOUNGE_NPC                      0x0052
#define ENB_OPCODE_0053_FIND_MEMBER						0x0053
...
#define ENB_OPCODE_0057_SKILL_UP		                0x0057
...
#define ENB_OPCODE_005D_EQUIP_USE	                    0x005D
#define ENB_OPCODE_005E_AVATAR_EMOTE					0x005E
#define ENB_OPCODE_005F_AVATAR_EMOTE_RESPONSE			0x005F

#define ENB_OPCODE_0061_AVATAR_DESCRIPTION              0x0061
#define ENB_OPCODE_0064_CLIENT_DAMAGE					0x0064
#define ENB_OPCODE_0065_UI_TRIGGER					    0x0065
#define ENB_OPCODE_0066_OPEN_INTERFACE					0x0066
...
#define ENB_OPCODE_0075_GLOBAL_ERROR					0x0075
#define ENB_OPCODE_0079_MANUFACTURE_ITEM_CATAGORY		0x0079
#define ENB_OPCODE_007A_MANUFACTURE_ITEM_CATAGORY		0x007A
#define ENB_OPCODE_007B_MANUFACTURE_ITEM_ID				0x007B
#define ENB_OPCODE_007C_REFINERY_ITEM_ID				0x007C
#define ENB_OPCODE_007E_MANUFACTURE_ACTION				0x007E
#define ENB_OPCODE_007F_MANUFACTURE_SET_MANUFACTURE_ID  0x007F

#define ENB_OPCODE_0080_MANUFACTURE_TECH_LEVEL_FILTER   0x0080
#define ENB_OPCODE_0081_RECUSTOMIZE_SHIP_START			0x0081
#define ENB_OPCODE_0082_RECUSTOMIZE_SHIP_DONE			0x0082
#define ENB_OPCODE_0083_RECUSTOMIZE_AVATAR_START		0x0083
#define ENB_OPCODE_0084_RECUSTOMIZE_AVATAR_DONE			0x0084
#define ENB_OPCODE_0085_RECUSTOMIZE_AVATAR_UPDATE		0x0085
#define ENB_OPCODE_0086_MISSION_FORFEIT					0x0086
#define ENB_OPCODE_0087_MISSION_DISMISSAL				0x0087
#define ENB_OPCODE_0088_PETITION_STUCK                  0x0088
#define ENB_OPCODE_0089_RELATIONSHIP                    0x0089
#define ENB_OPCODE_008B_ATTACKER_UPDATES				0x008B
#define ENB_OPCODE_008C_LOOT_HULK_PERMISSION            0x008C
#define ENB_OPCODE_008D_INCAPACITANCE_REQUEST           0x008D
#define ENB_OPCODE_0092_CAMERA_CONTROL                  0x0092
#define ENB_OPCODE_0093_JOB_LIST						0x0093
#define ENB_OPCODE_0094_JOB_DESCRIPTION					0x0094
#define ENB_OPCODE_0095_JOB_DELETE						0x0095  
#define ENB_OPCODE_0096_JOB_ACCEPT_REPLY				0x0096  
...
#define ENB_OPCODE_009B_WARP							0x009B
#define ENB_OPCODE_009C_WARP_INDEX						0x009C
...
#define ENB_OPCODE_00A3_CLIENT_CHAT_REQUEST             0x00A3	// Client to Server
#define ENB_OPCODE_00A4_CLIENT_CHAT_LIST				0x00A4	// Server to Client
#define ENB_OPCODE_00A5_CLIENT_CHAT_EVENT				0x00A5	// Server to Client Chat
#define ENB_OPCODE_00A6_CLIENT_CHAT_ERROR				0x00A6	// Server to Client
...
#define ENB_OPCODE_00BC_CTA_REQUEST						0x00BC
#define ENB_OPCODE_00BD_CTA_RESPONSE					0x00BD
#define ENB_OPCODE_00BE_CONFIRMED_ACTION_OFFER			0x00BE

#define ENB_OPCODE_00C0_CONFIRMED_ACTION_RESPONSE		0x00C0
#define ENB_OPCODE_00C5_GUILD_LEADER_ACCEPT_CLIENT		0x00C5
#define ENB_OPCODE_00C8_GUILD_RECRUIT_CONFIRM_SECTOR	0x00C8
#define ENB_OPCODE_00C9_GUILD_RECRUIT_ACCEPT_CLIENT		0x00C9
#define ENB_OPCODE_00CC_GUILD_SIMPLE_SECTOR_CLIENT		0x00CC
#define ENB_OPCODE_00CD_GUILD_SIMPLE_CLIENT_SECTOR		0x00CD

#define ENB_OPCODE_00D0_GUILD_MESSAGE_SECTOR			0x00D0
#define ENB_OPCODE_00D2_GUILD_PLAYER_PERMISSIONS		0x00D2
#define ENB_OPCODE_00D3_GUILD_RANK_NAMES_SECTOR			0x00D3
#define ENB_OPCODE_00D4_GUILD_RANK_NAMES_REQUEST_CLIENT	0x00D4
#define ENB_OPCODE_00D5_GUILD_RANK_NAMES_GUILD			0x00D5
#define ENB_OPCODE_00DD_GPS_REQUEST						0x00DD
...
//MVAS opcodes (MoveAssist)
//C_S client to server
//S_C server to client
...
#define ENB_OPCODE_100A_MVAS_TERMINATE_S_C              0x100A
#define ENB_OPCODE_100B_MVAS_PRE_START_S_C				0x100B

//UDP Proxy to Server opcodes
#define ENB_OPCODE_2000_ACCOUNTDATA                     0x2000
#define ENB_OPCODE_2001_ACCOUNTVALID                    0x2001
#define ENB_OPCODE_2002_TICKET                          0x2002
#define ENB_OPCODE_2003_AVATARLIST                      0x2003
#define ENB_OPCODE_2004_AVATARLOGIN                     0x2004
#define ENB_OPCODE_2005_AVATARLOGIN_CONFIRM             0x2005
...
#define ENB_OPCODE_200A_CLIENT_OPCODE                   0x200A  //ENB opcode for client, just forward it 'dumb' to sector connection
#define ENB_OPCODE_200B_CREATE_AVATAR                   0x200B
#define ENB_OPCODE_200C_CREATE_DELETE_AVATAR_CONFIRM    0x200C
#define ENB_OPCODE_200D_DELETE_AVATAR                   0x200D
#define ENB_OPCODE_200E_GLOBAL_ERROR                    0x200E
#define ENB_OPCODE_200F_COMM_PORT                       0x200F
#define ENB_OPCODE_2010_SET_GLOBAL_LOGIN_LINK			0x2010  //This opcode signals to the client that the TCP link is for login
#define ENB_OPCODE_2011_SET_PROXY_SECTOR_LINK			0x2011
#define ENB_OPCODE_2010_DATA_FILE                       0x2010
#define ENB_OPCODE_2011_GALAXY_MAP_CACHE                0x2011
#define ENB_OPCODE_2012_START_PROSPECT                  0x2012
#define ENB_OPCODE_2013_TRACTOR_ORE                     0x2013
#define ENB_OPCODE_2014_LOOT_ITEM                       0x2014
#define ENB_OPCODE_2015_STARBASE_AVATAR                 0x2015
#define ENB_OPCODE_2016_PACKET_SEQUENCE                 0x2016
#define ENB_OPCODE_2017_RESEND_PACKET_SEQUENCE          0x2017
#define ENB_OPCODE_2018_STATIC_OBJECT_CREATE			0x2018
#define ENB_OPCODE_2019_RESOURCE_OBJECT_CREATE			0x2019
#define ENB_OPCODE_201A_PACKET_C_SEQUENCE               0x201A

#define ENB_OPCODE_2020_LOGIN_STAGE_S_C					0x2020
#define ENB_OPCODE_2021_LOGIN_STAGE_ACK_C_S				0x2021


#define ENB_OPCODE_3000_WAIT_AUX                        0x3000  //this opcode queries Net7Proxy to ensure it has received all the Aux login opcodes
#define ENB_OPCODE_3001_AUX_RESPONSE                    0x3001  //this flags that all required AUX packets have been sent, or asks for certain to be re-sent
#define ENB_OPCODE_3002_TCP_LOGIN_VALIDATE              0x3002  //this tells the Server who the owner of the new TCP login link that's just opened is.
#define ENB_OPCODE_3003_TCP_LOGIN_CLOSE                 0x3003
#define ENB_OPCODE_3004_PLAYER_SHIP_SENT                0x3004
#define ENB_OPCODE_3005_PLAYER_COMMS_ALIVE              0x3005
#define ENB_OPCODE_3006_PLAYER_LOGIN_FAILED             0x3006
...
//Net7 tracking feed opcodes
#define ENB_OPCODE_5000_GET_PLAYER_COUNT				0x5000
#define ENB_OPCODE_5001_RETURN_PLAYER_COUNT				0x5001
