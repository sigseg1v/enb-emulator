...
#define ENB_OPCODE_200A_CLIENT_OPCODE                                                              \
    0x200A //ENB opcode for client, just forward it 'dumb' to sector connection
...
#define ENB_OPCODE_2010_SET_GLOBAL_LOGIN_LINK                                                      \
    0x2010 //This opcode signals to the client that the TCP link is for login
...
#define ENB_OPCODE_3000_WAIT_AUX                                                                   \
    0x3000 //this opcode queries Net7Proxy to ensure it has received all the Aux login opcodes
#define ENB_OPCODE_3001_AUX_RESPONSE                                                               \
    0x3001 //this flags that all required AUX packets have been sent, or asks for certain to be re-sent
#define ENB_OPCODE_3002_TCP_LOGIN_VALIDATE                                                         \
    0x3002 //this tells the Server who the owner of the new TCP login link that's just opened is.
