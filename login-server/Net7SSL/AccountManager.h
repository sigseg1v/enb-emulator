...
#define TICKET_EXPIRE_TIME  1800000  //30 minutes (ms). Must cover a human creating their first character at the char screen before sector entry binds the DTLS token; keep in sync with LinuxAuth.cpp kTicketExpireMs.
