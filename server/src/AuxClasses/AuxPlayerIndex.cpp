...
{
	ReplaceString(Data.CommunityEventFlags, NewCommunityEventFlags, 7, 64);
}
...
{
	ReplaceString(Data.RegistrationStarbase, NewRegistrationStarbase, 12, 64);	
}

void AuxPlayerIndex::SetRegistrationStarbaseSector(char * NewRegistrationStarbaseSector)
{
	ReplaceString(Data.RegistrationStarbaseSector, NewRegistrationStarbaseSector, 13, 64);
}

void AuxPlayerIndex::SetSectorName(char * NewSectorName)
{
	ReplaceString(Data.SectorName, NewSectorName, 14, 64);
}
