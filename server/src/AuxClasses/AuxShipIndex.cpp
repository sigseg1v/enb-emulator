...
void AuxShipIndex::SetName(char *NewName)
{
	ReplaceString(Data.Name, NewName, 0, 64);
}

void AuxShipIndex::SetOwner(char *NewOwner)
{
	ReplaceString(Data.Owner, NewOwner, 1, 64);
}

void AuxShipIndex::SetTitle(char *NewTitle)
{
	ReplaceString(Data.Title, NewTitle, 2, 64);
}

void AuxShipIndex::SetRank(char *NewRank)
{
...
{
	ReplaceString(Data.TargetThreat, NewTargetThreat, 28, 128);
}

void AuxShipIndex::SetTargetThreatSound(char *NewTargetThreatSound)
{
	ReplaceString(Data.TargetThreatSound, NewTargetThreatSound, 29, 128);
}
...
{
	ReplaceString(Data.GuildName, NewGuildName, 48, 64);
}
...
{
	ReplaceString(Data.GuildRankName, NewGuildRankName, 50, 64);
}
...
{
	ReplaceString(Data.InterruptAbilityName, NewInterruptAbilityName, 53, 128);
}
