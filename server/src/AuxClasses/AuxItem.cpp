...
u32 AuxItem::GetTradeStack()                        {return Data->TradeStack;}
...
{
	ReplaceString(Data->InstanceInfo, NewInstanceInfo, 6, 64);
}

void AuxItem::SetActivatedEffectInstanceInfo(char * NewActivatedEffectInstanceInfo)
{
	ReplaceString(Data->ActivatedEffectInstanceInfo, NewActivatedEffectInstanceInfo, 7, 64);
}

void AuxItem::SetEquipEffectInstanceInfo(char * NewEquipEffectInstanceInfo)
{
	ReplaceString(Data->EquipEffectInstanceInfo, NewEquipEffectInstanceInfo, 8, sizeof(Data->EquipEffectInstanceInfo));
}

void AuxItem::SetBuilderName(char * NewBuilderName)
{
	ReplaceString(Data->BuilderName, NewBuilderName, 9, 64);
}

void AuxItem::SetTradeStack(u32 NewTradeStack)
{
    // Sanitize input (note: eg. ammo can stack to 600)
    Data->TradeStack = ((NewTradeStack < 0  || NewTradeStack > 999) ? 0 : NewTradeStack);
}

void AuxItem::AddTradeStack(u32 Amount)
{
