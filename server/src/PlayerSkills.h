...
/*
Availability[0]: This stores the overall visibility / enable state 
0x01 - Used without a level or maxskill to indicate user does not have this skill 
0x03 - Used to set the skill as "Not yet attained", must supply a skill lvl of zero, otherwise the skill is unupdatable. 
0x04 - Normal state 

Availability[1]: Used to set the "Red cannot update because of.." 
0x00 - Normal, the skill can be updated 
0x01 - Cannot update, overall LVL too low 
0x02 - Cannot update, insufficient skill points 
0x04 - Does not allow to update, no error message 
0x08 - Cannot update, combat LVL too low 
0x10 - Cannot update, trade LVL too low 
0x20 - Cannot update, explore LVL too low 
0x40 - Cannot update, maximum skill level has been reached 
0x80 - Cannot update, prints "Only" as the error. 

Availability[2]: This stores the required level for the cannot update because of flags. 

Availability[3]: This stores the amount of skillpoints required to upgrade this skill. 
*/
struct SkillTemplate;
struct SkillClasses;

typedef enum // Availability[1]
{
...
#define SKILL_REACTOR_OPTIMISATION		43
...
#define REACTOR_BOOST 82
#define REACTOR_SURGE 83
#define REACTOR_EXTENSION 84
#define REACTOR_AUGMENTATION 85
#define REACTOR_OPTIMISATION 86
#define MAX_ABILITY_IDS	138
