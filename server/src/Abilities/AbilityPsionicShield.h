...
**
*/
#ifndef _ABILITY_PSIONIC_SHIELD_H_INCLUDED_
#define _ABILITY_PSIONIC_SHIELD_H_INCLUDED_

#include "AbilityBase.h"

class APsionicShield : public AbilityBase
{
public:
	APsionicShield(CMob *me) : AbilityBase(me, STAT_SKILL_PSIONIC_SHIELD) {}
public:
...
private:
	...
	float CalculateDamageAbsorb ( float SkillLevel, long SkillRank );
	...
	long GetLevelBasedRank(int combatLevel);
