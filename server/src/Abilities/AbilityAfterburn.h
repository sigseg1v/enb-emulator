...
**
*/
#ifndef _ABILITY_AFTERBURN_H_INCLUDED_
#define _ABILITY_AFTERBURN_H_INCLUDED_

#include "AbilityBase.h"
#include "ServerManager.h"
#include "PlayerClass.h"

class AAfterburn : public AbilityBase
{
public:
	AAfterburn(CMob * me);
...
private:
	...
	float CalculateSpeedIncrease(float SkillLevel, long SkillRank);
