...
**
*/
#ifndef _ABILITY_RALLY_H_INCLUDED_
#define _ABILITY_RALLY_H_INCLUDED_

#include "AbilityBase.h"

class ARally : public AbilityBase
{
public:
	ARally(CMob *me) : AbilityBase(me, STAT_SKILL_RALLY) {}
public:
...
private:
	...
	void CreateRallyBuff(CMob *recipient);
