...
**
*/
#ifndef _ABILITY_SUMMON_H_INCLUDED_
#define _ABILITY_SUMMON_H_INCLUDED_

#include "AbilityBase.h"

class ASummon : public AbilityBase
{
public:
	ASummon(CMob *me) : AbilityBase(me, STAT_SKILL_SUMMON) {}
public:
...
private:
	...
	bool RequiresTarget();
	bool IsGroupSkill();
	void SummonEnemy(bool randomise_position);
	void SummonFriend(int offset);
	void SummonObject(Object *obj);
	void FinaliseSummon();
};
