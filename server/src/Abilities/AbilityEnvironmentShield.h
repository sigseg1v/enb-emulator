...
**
*/
#ifndef _ABILITY_ENVIRONMENT_SHIELD_H_INCLUDED_
#define _ABILITY_ENVIRONMENT_SHIELD_H_INCLUDED_

#include "AbilityBase.h"

class AEnvironmentShield : public AbilityBase
{
public:
	AEnvironmentShield(CMob *me) : AbilityBase(me, STAT_SKILL_ENVIRONMENT_SHIELD) {}
public:
