...
**
*/
#ifndef _ABILITY_BIOREPRESSION_H_INCLUDED_
#define _ABILITY_BIOREPRESSION_H_INCLUDED_

#include "AbilityBase.h"

class ABioRepression : public AbilityBase
{
public:
	ABioRepression(CMob *me) : AbilityBase(me,STAT_SKILL_BIOREPRESSION) {}
...
private:
	...
	void  Repress(CMob *mob, long rank);
};
