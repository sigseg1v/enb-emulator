...
**
*/
#ifndef _ABILITY_ENERGY_LEECH_H_INCLUDED_
#define _ABILITY_ENERGY_LEECH_H_INCLUDED_

#include "AbilityBase.h"

class AEnergyLeech : public AbilityBase
{
public:
	AEnergyLeech(CMob *me) : AbilityBase(me, STAT_SKILL_ENERGY_LEECH) {}
public:
...
private:
	...
	float CalculateDrain ( float SkillLevel, long SkillRank );
	long DetermineSkillRank(int SkillID);
	void ProximityAOE(CMob *target, short seq, proxparam Drain, proxparam effect, proxparam p3);
};
