...
**
*/
#ifndef _ABILITY_SHIELD_CHARGING_H_INCLUDED_
#define _ABILITY_SHIELD_CHARGING_H_INCLUDED_

#include "AbilityBase.h"

class AShieldCharging : public AbilityBase
{
public:
	AShieldCharging(CMob *me) : AbilityBase(me, STAT_SKILL_SHIELD_CHARGING) {}
public:
