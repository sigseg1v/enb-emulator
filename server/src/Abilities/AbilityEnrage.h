...
**
*/
#ifndef _ABILITY_ENRAGE_H_INCLUDED_
#define _ABILITY_ENRAGE_H_INCLUDED_

#include "AbilityBase.h"

class AEnrage : public AbilityBase
{
public:
	AEnrage(CMob *me) : AbilityBase(me) {}
public:
...
private:
	...
	void  Enrage(CMob *mob, long rank);
};
