...
**
*/
#ifndef _ABILITY_AMENACE_H_INCLUDED_
#define _ABILITY_AMENACE_H_INCLUDED_

#include "AbilityBase.h"

class AMenace : public AbilityBase
{
public:
	AMenace(CMob *me) : AbilityBase(me, STAT_SKILL_MENACE) {}
public:
