...
**
*/
#ifndef _ABILITY_HACKING_H_INCLUDED_
#define _ABILITY_HACKING_H_INCLUDED_

#include "AbilityBase.h"

class AHacking : public AbilityBase
{
public:
	AHacking(CMob *me) : AbilityBase(me, STAT_SKILL_HULL_PATCH) {}
public:
