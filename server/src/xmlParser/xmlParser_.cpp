 ...
 *  <a href="http://www.applied-mathematics.net/tools/xmlParser.html">xmlParser</a>
 *
 ****************************************************************************
 */
...
const char * strVal(const char * Str)
{
    if (Str == 0)
        return null_str;
...
void XMLParserBase64Tool::alloc(int newsize)
{
    ...
    if (newsize>buflen && buf) { buf=realloc(buf,newsize); buflen=newsize; }
}
