      ...
      <div className={styles.account}>
        <form className={`${styles.accountCard} hud-panel hud-corners`} onSubmit={submit}>
          ...
          <label className="field">
            ...
            <input className="field__input mono" type="password" value={current}
          ...
          <label className="field">
            ...
            <input className="field__input mono" type="password" value={next}
          ...
          <label className="field">
            ...
            <input className="field__input mono" type="password" value={confirm}
