...
#define ENB_OPCODE_2000_ACCOUNTDATA                     0x2000  //Proxy->Server - username & pw
#define ENB_OPCODE_2001_ACCOUNTVALIDATE                 0x2001  //Server->Proxy - account valid
#define ENB_OPCODE_2002_TICKET                          0x2002  //Proxy->Server - send ticket 
#define ENB_OPCODE_2003_AVATARLIST                      0x2003  //Server->Proxy - Avatar list (on reception of ticket)
#define ENB_OPCODE_2004_AVATARLOGIN                     0x2004  //Proxy->Server - Avatar chosen, user logging in
#define ENB_OPCODE_2005_AVATARLOGIN_CONFIRM             0x2005  //Server->Proxy - Confirm login, send GameID
#define ENB_OPCODE_2006_SECTOR_VALIDATE                 0x2006  //only used by Net7 Server
#define ENB_OPCODE_2007_SECTOR_VALID_CONFIRM            0x2007  //only used by Net7 Server
#define ENB_OPCODE_2008_MASTER_HANDOFF                  0x2008  //Proxy->Server - user logging into sector
#define ENB_OPCODE_2009_MASTER_HANDOFF_CONFIRM          0x2009  //Server->Proxy - confirm user login, send port and IP of UDP sector server
...
#define ENB_OPCODE_2011_GALAXY_MAP_CACHE                0x2011  //This is a signal to Net7Proxy to send the galactic map to the client
...
// NB!!! Do not use opcodes greater than 0x7FFF, we use the top bit to indicate a continuation packet
