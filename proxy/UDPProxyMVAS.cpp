...
void UDPClient::PreStartReceived(char *msg)
{
	g_ServerShutdown = true;
	LogMessage("Server is in a startup cycle, will be online within a maximum of 5 minutes\n");
	::MessageBox(NULL, "Server is still starting up - should be online within 5 minutes", "Net7Proxy", MB_ICONINFORMATION);
}
