...
template <typename T> static void AddData(unsigned char* packet, T mydata, int& index) {
...
*/
template <> inline void AddData<long>(unsigned char* packet, long mydata, int& index) {
